...
class UserUoWAspect implements Aspect {
     ...
     * @Around("execution(public App\Data\UoWs\UserUoW->registerNew(*))")
     */
     ...
     *
     * @param MethodInvocation $invocation Invocation
     * @Around("execution(public App\Data\UoWs\UserUoW->registerDirty(*))")
     */
     ...
     *
     * @param MethodInvocation $invocation Invocation
     * @Around("execution(public App\Data\UoWs\UserUoW->registerDeleted(*))")
     */
     ...
     *
     * @param MethodInvocation $invocation Invocation
     * @Around("execution(public App\Data\Mappers\UserMapper->done(*))")
     */
